...
<header>
	<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
	  <div class="position-sticky">
		<div class="list-group list-group-flush mx-3 mt-4">
			...
			<a
			href="departemen.php" class="list-group-item list-group-item-action py-2 ripple active" aria-current="true" >
  ...
  <main style="margin-top: 58px;">
	<div class="container pt-4"> 
		<br>
			<div class="row mb-3">
			  <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Departemen</label>
			  <div class="col-sm-4">
				<input type="text" class="form-control form-control-lg " id="inputEmail3" name="namadepartemen" required>
			  </div>
			</div>
			<div class="row mb-3 pt-4">
				<label for="validationSelect" class="col-sm-2 col-form-label">Pilih Divisi</label>
				<div class="col-sm-4">
					<select class="form-select form-select-lg" aria-label="Default select example" name="id_divisi">
				<option></option>
					<?php 
			...
			<div class="row mb-3 pt-4">
				...
				<div class="col-sm-4">
					<select class="form-select form-select-lg" aria-label="Default select example" #name="id_direktorat" required>
				<option></option>
					<?php 
					include "../config/koneksi.php";
  ...
  if(isset($_POST['tambah'])){
	mysqli_query($koneksi,"insert into tbl_departemen set
	nama = '$_POST[namadepartemen]',	
