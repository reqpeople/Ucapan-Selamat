...
<header>
  ...
  <main style="margin-top: 58px;">
	<div class="container pt-4"> 
		<br>
			<div class="row mb-3">
			  <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Divisi</label>
			  <div class="col-sm-4">
				<input type="text" class="form-control form-control-lg" id="inputEmail3" name="nama" required>
			  </div>
			</div>
			<div class="row mb-3 pt-4">
				<label for="validationSelect" class="col-sm-2 col-form-label">Pilih Direktorat</label>
				<div class="col-sm-4">
				<select class="form-select form-select-lg" aria-label="Default select example" name="id_direktorat">
				<option></option>
					<?php 
  ...
  if(isset($_POST['tambah'])){
	mysqli_query($koneksi,"insert into tbl_divisi set
	nama = '$_POST[nama]',
