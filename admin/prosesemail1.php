...
if ( $tanggal) {
  ...
  echo"tanggal saat ini: $tanggalSaatIni<br>";
    ...
    // Bandingkan tanggal acara dengan tanggal saat ini
...
$color = getColorPathById($idColor, $bgColor);
    ...
    // Handle the case where the query does not return any result
    echo "Tidak dapat memperoleh data acara dari database.";
}
