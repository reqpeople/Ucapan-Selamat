		...
		<main style="margin-top: 58px;">
			<div class="container pt-5">
				...
				<div class="form row">
					<div class="form-group col-md-4">
						...
						<input type="text" class="form-control form-control form-control-lg" id="inputEmail3"
							name="nama_user" placeholder="Masukkan Nama Karyawan">
					</div>
					<div class="form-group col-md-4">
						<label for="inputEmail4" class="form-label">Jabatan</label>
						<input type="text" class="form-control form-control form-control-lg" id="inputEmail3"
							name="jabatan" placeholder="Masukkan Jabatan Karyawan">
					</div>
				</div>
				<p>
				<div class="form row">
					<div class="form-group col-md-4">
						<label for="inputEmail4" class="form-label">Pilih Departemen</label>
					...
					<div class="form-group col-md-4">
						...
						<select class="form-select form-select-lg" aria-label="Default select example" name="divisi">
							<option></option>
							<?php
							include "../config/koneksi.php";
				...
				<div class="form row">
					...
					<div class="form-group col-md-4">
						<label for="formFileMultiple" class="form-label">Masukkan Foto Profil</label>
