...
<title>Edit atau Hapus User </title>
</head>
<?php	
include "../config/koneksi.php";
$id=$_GET['id_divisi'];
$sql=mysqli_query($koneksi,"select * from tbl_divisi where id='$id'");
$data=mysqli_fetch_array($sql);
if(isset($_REQUEST['update'])){
	$nama =	$_POST['nama'];
	$nama = $_POST['id_divisi'];
	$nama = $_POST['id_direktorat'];
}
?>
<body>
<header>
	...
	<div class="container pt-4"> 
		...
		<form action="delete.php" method="post">
			<div class="row mb-3">
			  ...
			  <div class="col-sm-10">
				<input type="text" class="form-control" id="inputEmail3" name="nama_user" value="<?php echo $data['nama']; ?>">
			  </div>
			</div>
			<div class="row mb-3">
