...
<body>
		...
		<nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
			<div class="position-sticky pt-4">
				<div class="list-group list-group-flush mx-3 mt-4">
					...
					<a href="divisi.php" class="list-group-item list-group-item-action py-2 ripple" aria-current="true">
						<span>Divisi</span>
					</a>
	...
	<main style="margin-top: 58px;">
		<div class="container pt-5">
			<h2>Setting Departemen</h2>
			<a href="add_departemen.php"><button type="submit" class="btn btn-primary">Tambah Departemen</button></a>
			<p>
			...
			JOIN tbl_direktorat r ON u.id_direktorat=r.id");
					while ($tampil = mysqli_fetch_array($ambildata)) {
						...
						<tr>
							<td><a href="edit_departemen.php?id_departemen=<?php echo $tampil["id_departemen"] ?>">
							...
							<button type="submit" class="btn btn-danger" data-bs-toggle="modal"
									data-bs-target="#deleteModal_<?php echo $tampil["id_departemen"] ?>" value=<?php echo $tampil["id_departemen"] ?>>
									<i class="fa-solid fa-trash fs-6"></i>
								</button>

								<div class="modal fade" id="deleteModal_<?php echo $tampil['id_departemen'] ?>"
									...
									<div class="modal-dialog  modal-dialog-centered">
										<div class="modal-content">
											...
											<div class="modal-body ">
												<h4>Anda akan menghapus Departemen:</h4>
												<h5>
												<?= $tampil["nama_departemen"] ?>
												</h5>
											</div>
											<div class="modal-footer">
												...
												<a href="delete_dep.php?id_departemen=<?php echo $tampil['id_departemen'] ?>"
													class="link-primary">
